...
class AIConfig extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      host: '',
...
export default connect(mapStateToProps, { updateSetting, updateMultipleSettings })(AIConfig);
